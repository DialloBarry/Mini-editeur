...
public class IHM {
	...
	public void afficher() {
		...
		boxBoutonsV3.setBorder(BorderFactory.createEmptyBorder(0, 5, 5, 5));
		frame.add(boxBoutonsV3);
		frame.pack();
	...
	public void creerTousBoutons() {
		...
		creerBouton("Défaire", defaire, boxBoutonsV3);
		creerBouton("Refaire", refaire, boxBoutonsV3);
	}
